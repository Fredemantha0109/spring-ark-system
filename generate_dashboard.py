...
html = (
    ...
    "      .ark-page .text-\\[8px\\]  { font-size: 0.72rem !important; }\n"
    "      .ark-page .text-\\[9px\\]  { font-size: 0.78rem !important; }\n"
    "      .ark-page .text-\\[10px\\] { font-size: 0.88rem !important; }\n"
    "      .ark-page .text-\\[11px\\] { font-size: 0.94rem !important; }\n"
    "      .ark-page .text-xs  { font-size: 1rem    !important; }\n"
    "      .ark-page .text-sm  { font-size: 1.05rem !important; }\n"
    ...
    "      .ark-page .min-w-\\[60px\\] { min-width: 88px !important; padding-left: 1.25rem !important; padding-right: 1.25rem !important; }\n"
    "      .ark-page .min-w-\\[70px\\] { min-width: 96px !important; }\n"
    "    }\n"
    "    /* プライバシーモード */\n"
...
+ calendar_html +
    ...
    + f'<section><div class="flex items-baseline gap-3 mb-2"><span class="text-[10px] font-bold text-white/50 tracking-[.2em] uppercase">Weekly Condition</span><span class="text-[10px] text-white/50">{w_period}</span></div>'
    ...
    + f'<section><div class="flex items-baseline gap-3 mb-2"><span class="text-[10px] font-bold text-white/50 tracking-[.2em] uppercase">Monthly Condition</span><span class="text-[10px] text-white/50">{m_period}</span></div>'
